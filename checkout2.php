	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 col-xs-12 checkoutWrap">
				<div class="titleLevel1">Billing Information</div>
				<div class="clearfix"></div>
				<form action="">
					<div class="row">
						<div class="col-sm-6">
						...
						<div class="col-sm-12">
							<div class="form-group pmd-textfield">
							  	<label class="containerInput">Ship to this address
				                    <input name="radio1" type="radio" checked="checked">
				                    <span class="radioMark"></span>
				                </label>
							</div>
							<div class="form-group pmd-textfield">
							  	<label class="containerInput">Ship to another address
						...
						<div class="col-sm-6">
							<div class="form-group pmd-textfield">
							  	<button id="continueBilling" type="button" class="btn primaryBtn pmd-ripple-effect">Continue</button>
							</div>
						</div>
					</div>
